### This are my SQL exercises on the "LIMIT" clause
...
# R.- Alsem Cappello, Utz Mandell, Bouchung Schreiter, Baicai Kushner, Petter Stroustrup 
SELECT *
FROM employees
...
# R.- Pranay Narwekar, Marjo Farrow, Ennio Karcich, Dines Lubachevsky, Ipke Fontan
SELECT *
FROM employees
WHERE hire_date LIKE "199%"
    AND birth_date LIKE "%12-25"
